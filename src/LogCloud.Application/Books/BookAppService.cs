...
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(LogCloudPermissions.Books.Create)]
    ...
    [Authorize(LogCloudPermissions.Books.Edit)]
    ...
    [Authorize(LogCloudPermissions.Books.Delete)]
